...
import src.idm_mml.generator.MyDslGenerator;
import src.idm_mml.parser.antlr.MyDslAntlrTokenFileProvider;
import src.idm_mml.parser.antlr.MyDslParser;
import src.idm_mml.parser.antlr.internal.InternalMyDslLexer;
import src.idm_mml.scoping.MyDslScopeProvider;
import src.idm_mml.serializer.MyDslSemanticSequencer;
import src.idm_mml.serializer.MyDslSyntacticSequencer;
import src.idm_mml.services.MyDslGrammarAccess;
import src.idm_mml.validation.MyDslConfigurableIssueCodesProvider;
import src.idm_mml.validation.MyDslValidator;
...
public abstract class AbstractMyDslRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "src/idm_mml/MyDsl.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("src.idm_mml.MyDsl");
	}
